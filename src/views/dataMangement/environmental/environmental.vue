<template>
  <div class="appContation">
    ...
    <ul class="moudleWrap">
      <li @click="moudleNameClick('环境质量')" :class="{active:queryParams.moduleName === '环境质量'}">环境质量</li>
      <li @click="moudleNameClick('生态资源')" :class="{active:queryParams.moduleName === '生态资源'}">生态资源</li>
      <li @click="moudleNameClick('污染物排放')" :class="{active:queryParams.moduleName === '污染物排放'}">污染物排放</li>
      <li @click="moudleNameClick('生态资源状况')" :class="{active:queryParams.moduleName === '生态资源状况'}">生态资源状况</li>
    </ul>
