  ...
  <div class="appContation">
    <div class="mainWrapper">
      <div class="mainHeader">
        <span class="title">
          <el-page-header @back="jumpUrl('SynthesisAnalysis')" class="goBackBtn" :content="pageTitle"></el-page-header>
        </span>
        <el-form class="searchBar" ref="queryParams" :model="queryParams" label-width="80px" label-position="top"
          ...
          <el-form-item label="" prop="areas">
            <el-cascader v-model="areasArr" placeholder="请选择区域" :options="areaOptions" :show-all-levels="false"
              collapse-tags :props="{ multiple: true, checkStrictly: true }" clearable>
            </el-cascader>
          </el-form-item>
          <el-form-item label="" prop="startTime">
            <el-date-picker v-model="queryParams.startTime" type="year" value-format="yyyy" :clearable="false"
              placeholder="请选择开始年份">
            </el-date-picker>
          </el-form-item>
          <el-form-item label="" prop="endTime">
            <el-date-picker v-model="queryParams.endTime" type="year" value-format="yyyy" :clearable="false"
              placeholder="请选择选择结束年份">
            </el-date-picker>
          </el-form-item>
          <div class="btnGroup">
    ...
    <div class="mainWrapper">
      ...
      <div class="mainContent">
        <el-table ref="indicatorsTable" :data="indicatorsList" border fit highlight-current-row align="center"
          ...
          <el-table-column align="center" prop="quatoName" label="指标名称" sortable></el-table-column>
...
export default {
  ...
  // watch: {
  //   areasArr:{//深度监听，可监听到对象、数组的变化
  //        handler(val, oldVal){
  //          let areaOneArr = val.flat(Infinity)
  //          if (areaOneArr.includes('市级全选')) {
  //            this.areasArr = ['市级全选','杭州市','宁波市','温州市']
  //          }
  //            console.log(oldVal);
  //            console.log(areaOneArr);
  //            console.log(areaOneArr);
  //        },
  //        deep:true //true 深度监听
  //    }
