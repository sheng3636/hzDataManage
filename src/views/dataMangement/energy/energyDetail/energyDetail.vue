  ...
  <div class="appContation">
    <div class="mainWrapper">
      <div class="mainHeader">
        <span class="title">
          <el-page-header @back="jumpUrl('Energy')" class="goBackBtn" :content="pageTitle"></el-page-header>
        </span>
    ...
    <div class="mainWrapper">
      ...
      <div class="mainContent">
        <el-table ref="indicatorsTable" :data="indicatorsList" border fit highlight-current-row @selection-change="handleSelectionChange">
          ...
          <el-table-column align="center" prop="quatoName" label="指标名称"></el-table-column>
          ...
          <el-table-column width="180" align="center" fixed="right" label="操作">
            <template slot-scope="scope">
              <span class="optionBtn optionBtn2" @click="deleteClick(scope.row)"
                v-permission="['dataMangement/pageList']">删除</span>
            </template>
          </el-table-column>
        </el-table>
