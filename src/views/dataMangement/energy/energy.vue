<template>
  <div class="appContation">
    ...
    <ul class="moudleWrap">
      <li @click="moudleNameClick('能源供应')" :class="{active:queryParams.moduleName === '能源供应'}">能源供应</li>
      <li @click="moudleNameClick('能源效率')" :class="{active:queryParams.moduleName === '能源效率'}">能源效率</li>
      <li @click="moudleNameClick('能源消费')" :class="{active:queryParams.moduleName === '能源消费'}">能源消费</li>
    </ul>
        ...
        <el-table ref="titlesTable" :data="titlesList" border fit highlight-current-row>
          ...
          <el-table-column width="180" align="center" fixed="right" label="操作">
            <template slot-scope="scope">
              <span class="optionBtn optionBtn1" @click="jumpUrl('EnergyDetail',scope.row)" v-permission="['dataMangement/detail']">查看详情</span>
            </template>
          </el-table-column>
        </el-table>
