<template>
  <div class="appContation">
    ...
    <ul class="moudleWrap">
      <li @click="moudleNameClick('三次产业结构')" :class="{active:queryParams.moduleName === '三次产业结构'}">三次产业结构</li>
      <li @click="moudleNameClick('制造业结构')" :class="{active:queryParams.moduleName === '制造业结构'}">制造业结构</li>
      <li @click="moudleNameClick('服务业结构')" :class="{active:queryParams.moduleName === '服务业结构'}">服务业结构</li>
    </ul>
